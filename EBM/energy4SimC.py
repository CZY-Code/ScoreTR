...
class ScoreMatchingTime(nn.Module):
    def __init__(
        self,
        ...
        self.setup_energy_()
        self.time_embedding = GaussianFourierProjection(self.t_emb_size)
    ...
    def setup_energy_(self):
        ...
        # x encoder
        emb_size = 1 + self.t_emb_size * 2
        # emb_size = self.x_emb_size * 2 + self.t_emb_size * 2
    ...
    def forward(self, idx, t, x, sample=True, return_z=False):
        ...
        # x_exp = torch.cat([x, t], -1) #size [128, 1+8]
